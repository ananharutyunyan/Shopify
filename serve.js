...
const shopifyUrl = `https://simplysex.myshopify.com`
const previewUrl = `https://simplysex.myshopify.com?preview_theme_id=264798216`
...
compiler.plugin('done', (stats) => {
  ...
  shopify.sync(env, files).then(() => {
    ...
    hotMiddleware.publish({
      ...
      force: !(files.length === 1 && files[0] === 'theme.liquid')
    })
  }).catch((err) => {
